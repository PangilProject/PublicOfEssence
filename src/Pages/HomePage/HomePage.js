...
function HomePage() {
    const images = ["/Img/worship/worship3.jpg", "/Img/worship/worship5.jpg", "/Img/worship/worship6.jpg"];
    ...
    const handleNextClick = () => {
        ...
        setTimeout(() => {
            setCurrentImageIndex(
                (_prevIndex_) => _prevIndex_ === images.length - 1
                    ? 0
                    : _prevIndex_ + 1
            );
            setOpacity(1); // 다음 이미지 로드 후 opacity를 1로 설정
